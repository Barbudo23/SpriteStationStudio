...
- [ ] Добавить отдельную подтверждаемую команду применения TextureImporter-настроек.
...
Спроектировать отдельную подтверждаемую команду применения TextureImporter-настроек к уже экспортированным файлам. AI Center не развивать до отдельного решения пользователя.
