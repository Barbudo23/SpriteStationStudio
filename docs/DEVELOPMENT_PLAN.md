...
- Текущая разработка: ветка `post-rc/0.9.0-stabilization`.
- Опубликованный RC1 и исходный artifact остаются привязаны к tag `v0.9.0-rc1` и commit `df8613c5`.
- Post-RC изменения выполняются по `docs/POST_RC_STABILIZATION.md`; старая ветка сохраняется как историческая точка без удаления.
...
## Этап 2 — v0.8.3 Static Sprite Pipeline (завершённая основа)
...
# Current authoritative status — v0.10.0 RC2

Updated: 2026-07-30.

This section supersedes stale v0.9 branch and “next action” references retained
above as historical development trace.
...
- [x] 1. Repeat affected Windows GUI no-overwrite scenarios from the RC2 build.
