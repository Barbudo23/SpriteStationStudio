...
- [ ] Добавить read-only preview команды импорта в изолированный Unity Bridge.
...
Добавить read-only preview Unity-импорта по `unity_import_preset.json`, не копируя файлы в пользовательский проект. AI Center не развивать до отдельного решения пользователя.
