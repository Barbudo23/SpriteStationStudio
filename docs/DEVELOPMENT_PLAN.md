...
- [ ] Добавить явный экспорт проверенного пакета в выбранную папку `Assets` с подтверждением пользователя.
...
Спроектировать явный экспорт проверенного пакета в выбранную папку `Assets` с предварительным подтверждением и без перезаписи существующих файлов. AI Center не развивать до отдельного решения пользователя.
