...
На этом этапе экспорт переносит файлы и контракт настроек. Unity создаёт собственные `.meta`; автоматическое применение TextureImporter-настроек будет отдельным этапом после дополнительной проверки совместимости Unity API.
