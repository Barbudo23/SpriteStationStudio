...
GitHub prerelease `v0.9.0-rc1` опубликован для проверенного commit `df8613c5`. Следующий этап — ограниченный post-RC цикл исправлений; Stable требует отдельного решения.
